...
== Changelog ==
= 4.0.08 =
* Release 4.0.08  - 08/06/26
	* Fix to image compare block
= 4.0.05 =
* Release 4.0.05  - 06/22/26
	* Fix to borders on the widget row
* Release 3.2.83 - 03/31/26
	* Fix to Featured Image to update image ratios
= 3.2.80 - 3.2.82 =
* Release 3.2.80 - 03/17/26
	* Added Load more button to Event Archive
	* Fixed anchor on Event archive and Custom Archive
= 3.2.76 - 3.2.80=
* Release 3.2.76 - 03/17/26
	* Added an Image Compare Block
= 3.2.75 =
* Release 3.2.75 - 03/14/26
	* Update to fixed image to use aspect ratio instead of absolute + padding
= 3.2.74 =
...
= 3.2.70 =
* Release 3.2.70 - 02/11/26
	* Added schema to Accordion for FAQ
= 3.2.69 =
...
= 3.2.66 =
* Release 3.2.65 - .66 = 12/7/25
	* Fix to load styles with the appropriate blocks to solve 6.9 issues
= 3.2.64 =
* Release 3.2.64 = 12/4/25
	* Fix to load modal style with archive
= 3.2.63 =
