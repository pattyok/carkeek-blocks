...
/*!********************************************!*\
  !*** ./src/button-expand-collapse/view.js ***!
  \********************************************/
// File#: _1_collapse
...
(function () {
  ...
  function initCollapse(element) {
    if (element.trigger) {
      ...
      updateTriggers(element, element.expanded); // detect click on trigger elements
    ...
    updateTarget(element, element.expanded); // custom event
    ...
    window.addEventListener('resize', function () {
      ...
      if (!throttled) {
        ...
        updateTarget(element, expanded); // we're throttled!
  ...
  ;
  window.Collapse = Collapse; //initialize the Collapse objects
  ...
  initCollapseBlock(); // window.resize event listener
})();
/******/ })()
;
