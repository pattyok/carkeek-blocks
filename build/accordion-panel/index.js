...
function Edit(props) {
  ...
  if (!inheritedHeaderStyle) {
    setAttributes({
      inheritedHeaderStyle: context['carkeek-blocks/headerStyle'] || 'h3'
    });
  }

  if (inheritedisFAQ === undefined) {
    setAttributes({
      inheritedisFAQ: context['carkeek-blocks/isFAQ'] || false
    });
  }
...
function save(_ref) {
  ...
  if (inheritedisFAQ) {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(HeaderEl, {
      "data-aria-accordion-heading": true,
      className: "ck-accordion-header faq-header",
      itemscope: "",
      itemprop: "mainEntity",
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"carkeek-blocks/accordion-panel","version":"0.1.0","title":"Accordion Panel","category":"widgets","description":"Example block scaffolded with Create Block tool.","supports":{"html":false,"align":["wide","full"],"__experimentalLayout":{"type":"constrained"}},"parent":["carkeek-blocks/accordion"],"usesContext":["carkeek-blocks/headerStyle","carkeek-blocks/isFAQ"],"textdomain":"carkeek-blocks","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","attributes":{"title":{"type":"string"},"inheritedHeaderStyle":{"type":"string"},"inheritedisFAQ":{"type":"boolean"},"layout":{"type":"object","default":{"type":"constrained"}}}}');
