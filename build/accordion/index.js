...
function Edit(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.CheckboxControl, {
    ...
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("If selected, the FAQ Schema will be applied.", "carkeek-blocks")
...
function save(_ref) {
  ...
  let blockProps = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.useBlockProps.save();

  if (expandIcon) {
    blockProps = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.useBlockProps.save({
      className: `has-expand-icon-${expandIcon}`
    });
  }
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
    "data-aria-accordion": true,
    "data-transition": true
  }, multi), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.InnerBlocks.Content, null)));
}
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"carkeek-blocks/accordion","version":"2.0.1","title":"Accordion Block","category":"widgets","description":"Accordion block.","supports":{"html":false,"align":["wide","full"],"spacing":{"padding":true,"margin":true}},"keywords":["accordion","toggle","expand","colllapse"],"styles":[{"name":"default","label":"Standard Accordion","isDefault":true},{"name":"mini","label":"Mini Style"}],"providesContext":{"carkeek-blocks/isFAQ":"isFAQ","carkeek-blocks/headerStyle":"headerStyle"},"textdomain":"carkeek-blocks","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","attributes":{"headerStyle":{"type":"string","default":"h3"},"expandIcon":{"type":"string","default":""},"openMultiple":{"type":"boolean","default":true},"isFAQ":{"type":"boolean","default":false},"style":{"type":"object","default":{"spacing":{"margin":{},"padding":{}}}}}}');
