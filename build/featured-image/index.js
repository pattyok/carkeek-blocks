...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"carkeek-blocks/featured-image","title":"Featured Image","category":"widgets","description":"Place the featured image within your page","keywords":["image","featured"],"textdomain":"carkeek-blocks","attributes":{"focalPoint":{"type":"object"},"blockId":{"type":"string"},"imageSize":{"type":"string"},"className":{"type":"string"},"showCaption":{"type":"boolean","default":false},"style":{"type":"object","default":{"spacing":{"margin":{},"padding":{}}}}},"styles":[{"name":"landscape","label":"Landscape","isDefault":true},{"name":"square","label":"Square"},{"name":"portrait","label":"Portrait"},{"name":"no-crop","label":"No Crop"}],"supports":{"align":["wide","full","left","center","right"],"anchor":false,"spacing":{"padding":true,"margin":true}},"editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["featured-image/style-index"], () => (__webpack_require__("./src/featured-image/index.js")))
